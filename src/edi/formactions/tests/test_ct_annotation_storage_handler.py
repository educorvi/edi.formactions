from edi.formactions.content.annotation_storage_handler import IAnnotationStorageHandler
...
class AnnotationStorageHandlerIntegrationTest(unittest.TestCase):
    ...
    def test_ct_annotation_storage_handler_factory(self):
        ...
        self.assertTrue(
            ...
            f"IAnnotationStorageHandler not provided by {obj}!",
        )
    ...
    def test_ct_annotation_storage_handler_adding(self):
        ...
        self.assertTrue(
            IAnnotationStorageHandler.providedBy(obj),
            f"IAnnotationStorageHandler not provided by {obj.id}!",
        )
